...
function CanIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" className="shrink-0 mt-0.5">
      <rect x="7" y="5" width="10" height="15" rx="2" ry="2" stroke="#173A57" strokeWidth="1.5" fill="none" />
      <ellipse cx="12" cy="5" rx="5" ry="1.5" stroke="#173A57" strokeWidth="1.5" fill="none" />
      <ellipse cx="12" cy="20" rx="5" ry="1.5" stroke="#173A57" strokeWidth="1.5" fill="none" />
      <line x1="12" y1="3.5" x2="12" y2="5" stroke="#173A57" strokeWidth="1.5" strokeLinecap="round" />
      <circle cx="12" cy="3" r="1" stroke="#173A57" strokeWidth="1.2" fill="none" />
    </svg>
  );
}
        ...
        <div className="flex flex-col gap-8 sm:gap-12 lg:flex-row lg:gap-16 justify-center">
            ...
            <div className="border border-white/30 rounded-lg p-5 lg:p-6 flex flex-col gap-3">
              ...
              <div className="mt-2">
                <button
                  ...
                  disabled={pending}
                  className="w-full bg-[#FDF277] hover:bg-[#f5e751] text-[#173A57] font-bold text-[15px] py-3 rounded-full transition-all duration-300 mb-1 cursor-pointer active:scale-95 sm:text-[21px] sm:hover:scale-105 sm:hover:shadow-[0_0_30px_rgba(253,242,119,0.4)] disabled:cursor-not-allowed disabled:opacity-70 disabled:hover:scale-100 disabled:hover:shadow-none"
                >
          ...
          <FadeRight delay={300} className="flex flex-col gap-6 w-full lg:max-w-[494px] lg:mt-14">
            <div className="w-full">
              <img alt="AWAKE Cans"
                src="https://cdn.prod.website-files.com/6719e8a01505503c09134c42/69b9aaa518494045835ed03e_erlebe-den-awake-effekt%20(1).avif"
