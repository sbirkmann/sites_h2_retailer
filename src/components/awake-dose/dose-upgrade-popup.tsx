...
> = {
  monthly: {
    headline: "Nur 76,24€ statt 89,70€ monatlich",
    subline:
      "auf deine 30 Extradosen (2,54 € pro Dose, inkl. MwSt., exkl. 0,25€ Pfand)",
  },
  quarterly: {
    headline: "Nur 68,58€ statt 80,69€ monatlich",
    subline:
      "auf deine 30 Extradosen (2,28 € pro Dose, inkl. MwSt., exkl. 0,25€ Pfand)",
  },
  halfYear: {
    headline: "Nur 60,94€ statt 71,70€ monatlich",
    subline:
      "auf deine 30 Extradosen (2,03 € pro Dose, inkl. MwSt., exkl. 0,25€ Pfand)",
  },
};

const BODY_TEXT =
  "Verdopple deine Ration und erhalte insgesamt 60 Dosen AWAKE pro Monat. Perfekt für Menschen mit hohem Leistungsanspruch, Familien oder Athleten.";

const BENEFITS = [
  "2 Tagesrationen AWAKE pro Tag",
  "Dein Upgrade ist monatlich kündbar",
...
const PRODUCT_IMAGE_URL =
  "https://subbly-production-builder.nyc3.cdn.digitaloceanspaces.com/projects/01KKKA91702C19QGM77B03DASV/uploads/985c8bc1-a33c-44dc-81dc-9daf088b1df1-image.png";

type DoseUpgradePopupProps = {
...
export function DoseUpgradePopup({
  standardPlan,
  upgradePlan,
  pending,
  onConfirm,
  ...
  const planContent =
    PLAN_CONTENT[standardPlan.variant] ?? PLAN_CONTENT.monthly;

  return (
    <div
      role="dialog"
      aria-modal="true"
      aria-labelledby="dose-upgrade-title"
      aria-describedby="dose-upgrade-desc"
