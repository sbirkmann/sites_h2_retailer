      ...
      <div className="mx-auto max-w-[1350px]">
        ...
        <div className="grid grid-cols-2 gap-3 sm:gap-6 md:grid-cols-3 lg:gap-8">
          {ambassadors.map((ambassador, idx) => (
            <PopIn key={ambassador.name} delay={idx * 150} className={`relative group overflow-hidden rounded-lg border border-white aspect-[4/5] md:aspect-auto md:h-[500px] sm:hover:-translate-y-2 transition-transform duration-500 ${ambassador.name === "Marvin Alberg" ? "md:hidden" : ""}`}>
