    ...
    <section className="pt-10 bg-[#F5F5F5] overflow-hidden relative sm:pt-12 lg:pt-24">
      ...
      <div className="relative w-full h-[500px] hidden lg:block">
        <div className="relative h-full mx-auto max-w-[1200px]">
          <svg viewBox="0 -60 1200 540" preserveAspectRatio="xMaxYMax slice" aria-hidden="true" className="absolute bottom-0 -right-[420px] h-[450px] w-[1000px]">
            <ellipse cx="520" cy="520" rx="640" ry="530" fill="#173A57" />
          </svg>

        <PopIn className="absolute -bottom-32 left-1/2 -translate-x-1/2 w-[280px] z-20">
          <img src="https://cdn.prod.website-files.com/6719e8a01505503c09134c42/69db4f360c3cdb165a1054a5_flasche-awake.avif" alt="AWAKE Flasche" className="w-full h-auto drop-shadow-2xl" />
        </PopIn>
        ...
        <FadeRight className="absolute -right-4 bottom-8 w-[380px] text-white z-30 pointer-events-auto hidden lg:block">
          <div className="flex flex-col gap-3">
            ...
            <div className="flex gap-8 justify-center pointer-events-auto">
              <button onClick={handlePrev} className="hover:opacity-70 transition-opacity cursor-pointer" aria-label="Vorheriger Wirkbereich">
              ...
              <button onClick={handleNext} className="hover:opacity-70 transition-opacity cursor-pointer" aria-label="Nächster Wirkbereich">
                <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
