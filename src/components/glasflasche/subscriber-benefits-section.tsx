...
export function SubscriberBenefitsSection() {
  const benefits = [
  {
    title: "24 Flaschen alle 24 Tage",
    ...
    image: "https://cdn.prod.website-files.com/6719e8a01505503c09134c42/69db7a19feb6e333c19aed4a_awake%20flaschen.avif",
    list: ["24 Flaschen alle 24 Tage", "Rabattiertes Upgrade auf 48 Flaschen möglich", "Direkt nach Hause geliefert"]
  },
  {
    title: "Großer H2-Guide",
    ...
    image: "https://cdn.prod.website-files.com/6719e8a01505503c09134c42/69db509017678ef5f1dbbb61_awake_guide_cool.avif",
    list: ["Exklusives H2-Wissen", "Wissenschaftliche Studien über Wasserstoff", "Anwendungs-Tipps und mehr"]
  },
  {
    title: "Monatlicher AWAKE Talk",
  ...
  return (
    <section className="bg-[#173A57] py-12 sm:py-16 lg:py-24 px-4 lg:px-8 text-white relative overflow-hidden">
      ...
      <div className="mx-auto max-w-[1350px] relative z-10">
        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 md:grid-cols-3 sm:gap-6 lg:gap-8 mb-12 sm:mb-16">
          {benefits.map((benefit, idx) =>
          <div key={idx} className="relative">
              <PopIn delay={idx * 150} className="bg-transparent border border-[#C3C9CD] rounded-lg overflow-hidden flex flex-col h-full group sm:hover:-translate-y-2 hover:border-[#FDF277]/50 transition-all duration-300">
                <div className="relative aspect-[4/3] w-full overflow-hidden">
                  <img src={benefit.image} alt={benefit.title} className="object-cover w-full h-full group-hover:scale-105 transition-transform duration-700 ease-out" />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent" />
                  <h3 className="absolute bottom-4 left-5 right-5 font-gothic font-bold text-[18px] text-[#FDF277] z-10 text-center">{benefit.title}</h3>
                </div>
                <div className="p-6 flex flex-col flex-1 items-center text-center">
                  ...
                  <div key={i} className="flex items-center gap-2.5">
                        ...
                        <span className="text-white font-bold text-left text-[14px] rounded-none">{item}</span>
                      </div>
                  )}
                  </div>
                </div>
            ...
            <>
                  <div
                aria-hidden
                className="md:hidden absolute left-1/2 -bottom-5 -translate-x-1/2 translate-y-1/2 w-10 h-10 rounded-full bg-white shadow-lg flex items-center justify-center z-20">
                
                    <svg className="w-5 h-5 text-[#173A57]" fill="none" stroke="currentColor" strokeWidth={3} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M12 5v14M5 12h14" /></svg>
                  </div>
                  <div
                aria-hidden
                className="hidden md:flex absolute top-1/2 -right-3 lg:-right-4 -translate-y-1/2 translate-x-1/2 w-10 h-10 lg:w-12 lg:h-12 rounded-full bg-white shadow-lg items-center justify-center z-20">
                
                    <svg className="w-5 h-5 lg:w-6 lg:h-6 text-[#173A57]" fill="none" stroke="currentColor" strokeWidth={3} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M12 5v14M5 12h14" /></svg>
                  </div>
                </>
            }
            </div>
